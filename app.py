...
def _load_external_icon(theme_name: str):
    file_map = {"light": "Light Mode.png", "dark": "Dark Mode.png"}
    file_name = file_map.get(theme_name)
    if not file_name:
        return None

    icon_path = BASE_DIR / "icons" / theme_name / file_name
